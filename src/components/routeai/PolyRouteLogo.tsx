...
export function PolyRouteLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 162 32" // Adjusted viewBox to give more space for text
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      {...props} // Allows overriding width/height via props, e.g., className="h-8"
    >
      {/* Polygon-like Icon Group: Scaled and positioned */}
      {/* Original Polygon path viewBox is roughly 0,0 to 36,31 */}
      {/* This path is an approximation of the Polygon logo symbol */}
      <g transform="translate(0 3.5) scale(0.85)">
        <path
          ...
          fill="hsl(var(--primary))" // Use primary theme color
        />
      </g>
      {/* PolyRoute Text */}
      <text
        x="42" // Positioned to the right of the icon
        y="22.5" // Vertically aligned (approximate baseline for Inter font)
        fontFamily="Inter, sans-serif" // Ensuring consistent font
        fontSize="20" // Slightly adjusted font size
