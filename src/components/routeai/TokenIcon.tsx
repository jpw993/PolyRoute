...
// SVGs based on common representations, simplified for embedding
const Svgs: Record<string, React.FC<SVGProps<SVGSVGElement>>> = {
  POL: (props) => ( // Polygon - stylized purple P or geometric shape
    <svg viewBox="0 0 100 100" {...props}>
      <polygon points="50,5 95,25 95,75 50,95 5,75 5,25" fill="#8247E5"/>
    </svg>
  ),
  USDC: (props) => ( // USD Coin - blue circle with stylized C/$
    <svg viewBox="0 0 100 100" {...props}>
  ...
  DAI: (props) => ( // DAI - orange diamond/rhombus
    <svg viewBox="0 0 100 100" {...props}>
      <path d="M50 5 L95 50 L50 95 L5 50 Z" fill="#F5AC37"/>
    </svg>
  ),
  WETH: (props) => ( // Wrapped Ether - Ethereum logo, often greyed or with wrapper
    <svg viewBox="0 0 64 64" {...props}>
      ...
      {/* Top Inner Triangle */}
      <path fill="#BBBBBB" d="M32 2l18.375 30.469L32 32.469z"/>
      {/* Bottom Inner Triangle */}
      <path fill="#A0A0A0" d="M32 45.5l18.375-9.781L32 32.469z"/>
    </svg>
  ),
  WBTC: (props) => ( // Wrapped Bitcoin - Bitcoin logo
  ...
  AAVE: (props) => ( // Aave - Ghost-like icon
    <svg viewBox="0 0 100 100" {...props}>
